...
svartpinne = circle(10,"solid", "black")
...
#Framne er 500, 120 fordi sirklene kanter med rammen, og etter vår mening blir det mer oversiktelig. 
frame1 = empty-scene(500, 120)
#De ulike trekkene en må i gjennom for å fullføre spillet. Det blir ikke  mye spill, men mer en algoritme hvor en skriver "trekk()" 16 ganger før en "vinner".  
...
Viktige-funksjoner = "spill(), trekk(), rewind(), nyttspill(), oversikt()"
...
#Denne funksjonen lar spilleren ta et "stepback", som vi kaller det. Dette vil la spilleren gå et steg tilbake, ved å sette indexen tilbake ett tall, og med det skape et litt mer dynamisk spill, istedenfor å ha en kjedelig rekke med "trekk()" for å gå igjennom. et spill.
fun stepback():
 if aktiv == "on":
 block:
 ...
 liste.get-now(index)
    ...
    feil = "Skriv spill() først, vi vet du klarer det!"
 feil
 end
end